...
//CALCULATING SECTION CHANCES
		...
		IEnumerator GameOver(float delay)
		{
			...
			if ( gameOverCanvas )    
			{
				...
				gameOverCanvas.Find("Base/Texts/TextScore").GetComponent<Text>().text = "本局得分 " + score.ToString();
				...
				gameOverCanvas.Find("Base/Texts/TextHighScore").GetComponent<Text>().text = "最高得分 " + highScore.ToString();
