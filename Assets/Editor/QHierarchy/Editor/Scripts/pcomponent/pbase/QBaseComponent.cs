...
namespace qtools.qhierarchy.pcomponent.pbase
{
    public class QBaseComponent
    {
        ...
        // PUBLIC
        public virtual void layout(GameObject gameObject, ref Rect curRect)
        {

        }

        public virtual void draw(GameObject gameObject,Rect selectionRect, Rect curRect)
        {

        }

        public virtual void eventHandler(GameObject gameObject, Event currentEvent, Rect curRect)
        {
